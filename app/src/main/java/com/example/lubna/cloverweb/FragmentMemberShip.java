...
public class FragmentMemberShip extends Fragment {
    ...
    private List<Model_Membership> m_accounts;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        view = inflater.inflate(R.layout.fragment_member_ship, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.rv_membership);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                if (!jsonObject.isNull("0")) {
                                    ...
                                    for (int j = 0; j < innerArray.length(); j++) {
                                        ...
                                        Model_Membership items = new Model_Membership(
                                                account_id,
                                                i_d[0],
                                                e_d[0],
                                                account_title,
                            ...
                            adapter = new Adapter_Membership(m_accounts, getContext());
